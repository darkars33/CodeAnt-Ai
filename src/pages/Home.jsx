          ...
          <div className="p-3">
            <div className="flex justify-between items-start flex-wrap">
              ...
              <div className="p-3 flex gap-3 md:px-0">
                <button
                  className="flex items-center gap-2 p-2  border-[2px] rounded-md text-sm hover:bg-gray-100"
                  onClick={handleRefresh}
                  style={{ color: Colors.text2 }}
                >
                  <Icons.Refresh className="text-black w-4 h-4" /> Refresh All
                </button>
                <button
                  className="flex items-center gap-2 p-2 border rounded-md text-sm text-white md:text-[0.8rem] hover:bg-blue-300"
                  style={{ backgroundColor: Colors.button,  }}
                >
                  <Icons.Add className="w-5 h-5" /> Add Repositories
                </button>
              </div>
            </div>
            <div className="w-[20rem] md:w-[100%] px-3 relative md:p-0">
              <Icons.Search className="absolute top-1 left-4 md:left-1 text-black w-6 h-6" />
              <input
                type="text"
